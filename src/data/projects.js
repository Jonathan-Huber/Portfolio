...
const projects = [
  {
    ...
    cover: {
      src: getImage("riding-cities/cover-1480.webp"),
      width: 1480,
      height: 987,
      // srcSet: `
      ...
      // `,
      // sizes: "",
      alt: "Riding Cities - partie haute de la page d'accueil",
    },
    gallery: [
      {
        src: getImage("riding-cities/1-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Riding Cities - partie basse de la page d'accueil",
      },
      //     {
...

  {
    ...
    cover: {
      src: getImage("booki/cover-1480.webp"),
      width: 1480,
      height: 987,
      // srcSet: "Versions responsives de cette image",
      // sizes: "",
      alt: "Booki - page d'accueil",
    },
    gallery: [
      {
        src: getImage("booki/1-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Booki - mockup tablette du site (deux vues)",
      },
      {
        src: getImage("booki/2-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Booki - mockup mobile du site (trois vues)",
      },
    ],
  },

  {
    ...
    cover: {
      src: getImage("ohmyfood/cover-1480.webp"),
      width: 1480,
      height: 987,
      // srcSet: "Versions responsives de cette image",
      // sizes: "",
      alt: "Oh My Food - page d'accueil",
    },
    gallery: [
      {
        src: getImage("ohmyfood/1-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Oh My Food - page menu restaurant",
      },
      {
        src: getImage("ohmyfood/2-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Oh My Food- mockup mobile du site (trois vues)",
      },
    ],
...

  {
    ...
    cover: {
      src: getImage("sophie-bluel/cover-1480.webp"),
      width: 1480,
      height: 987,
      // srcSet: "Versions responsives de cette image",
      // sizes: "",
      alt: "Sophie Bluel - section À propos",
    },
    gallery: [
      {
        src: getImage("sophie-bluel/1-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Sophie Bluel - galerie de projets",
      },
      {
        src: getImage("sophie-bluel/2-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Sophie Bluel - section Contact",
      },
      {
        src: getImage("sophie-bluel/3-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Sophie Bluel - galerie de projets filtrée",
      },
      {
        src: getImage("sophie-bluel/4-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Sophie Bluel - page de connexion",
      },
      {
        src: getImage("sophie-bluel/5-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Sophie Bluel - page d'accueil en mode administrateur",
      },
      {
        src: getImage("sophie-bluel/6-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Sophie Bluel - modale de suppression de projets",
      },
      {
        src: getImage("sophie-bluel/7-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Sophie Bluel - modale d'ajout' de projets",
      },
    ],
    repoLink:
...

  {
    ...
    cover: {
      src: getImage("kasa/cover-1480.webp"),
      width: 1480,
      height: 987,
      // srcSet:"Versions responsives de cette image",
      // sizes: "",
      alt: "Kasa - page d'accueil",
    },
    gallery: [
      {
        src: getImage("kasa/1-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Kasa - page de logement",
      },
      {
        src: getImage("kasa/2-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Kasa - page À propos",
      },
      {
        src: getImage("kasa/3-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Kasa - mockup mobile du site (trois vues)",
      },
    ],
    repoLink: "https://github.com/Jonathan-Huber/Kasa",
    liveLink: "https://kasa-jonathan-huber.vercel.app",
  },

  {
    ...
    cover: {
      src: getImage("nina-carducci/cover-1480.webp"),
      width: 1480,
      height: 987,
      // srcSet: "Versions responsives de cette image",
      // sizes: "",
      alt: "Nina Carducci - Hero et section À propos",
    },
    gallery: [
      {
        src: getImage("nina-carducci/1-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Nina Carducci - Galerie de photos",
      },
      {
        src: getImage("nina-carducci/2-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Nina Carducci - modale du carrousel de la galerie de photos",
      },
      {
        src: getImage("nina-carducci/3-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Nina Carducci - section mes services",
      },
      {
        src: getImage("nina-carducci/4-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Nina Carducci - mockup mobile du site (trois vues)",
      },
      {
        src: getImage("nina-carducci/5-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "Nina Carducci - résultats Lighthouse avant/après et Rich Results Test",
      },
    ],
...

  {
    ...
    cover: {
      src: getImage("724events/cover-1480.webp"),
      width: 1480,
      height: 987,
      // srcSet: "Versions responsives de cette image",
      // sizes: "",
      alt: "724events - section hero et nos services",
    },
    gallery: [
      {
        src: getImage("724events/1-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "724events - galerie section nos réalisations",
      },
      {
        src: getImage("724events/2-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "724events - section notre équipe",
      },
      {
        src: getImage("724events/3-1480.webp"),
        width: 1480,
        height: 987,
        // srcSet: "Versions responsives de cette image",
        alt: "724events - section contact",
      },
    ],
  ...
  },
  {
    ...
    cover: {
      src: getImage("argent-bank/cover-1480.webp"),
      // srcSet: "Versions responsives de cette image",
      // sizes: "",
      alt: "Argent Bank - page d'accueil",
    },
    gallery: [
      {
        src: getImage("argent-bank/1-1480.webp"),
        // srcSet: "Versions responsives de cette image",
        alt: "Argent Bank - page de connexion",
      },
      {
        src: getImage("argent-bank/2-1480.webp"),
        // srcSet: "Versions responsives de cette image",
        alt: "Argent Bank - page profil utilisateur et gestion des comptes",
      },
      {
        src: getImage("argent-bank/3-1480.webp"),
        // srcSet: "Versions responsives de cette image",
        alt: "Argent Bank - formulaire de modification du nom d'utilisateur",
      },
      {
        src: getImage("argent-bank/4-1480.webp"),
        // srcSet: "Versions responsives de cette image",
        alt: "Argent Bank - nom d'utilisateur modifié et navbar mise à jour via Redux",
      },
      {
        src: getImage("argent-bank/5-1480.webp"),
        // srcSet: "Versions responsives de cette image",
        alt: "Argent Bank - Swagger endpoint GET /accounts",
      },
      {
        src: getImage("argent-bank/6-1480.webp"),
        // srcSet: "Versions responsives de cette image",
        alt: "Argent Bank - Swagger endpoint GET /accounts/{accountId}/transactions",
      },
      {
        src: getImage("argent-bank/7-1480.webp"),
        // srcSet: "Versions responsives de cette image",
        alt: "Argent Bank - Swagger endpoint GET /transactions/{transactionId} avec identifiant",
      },
      {
        src: getImage("argent-bank/8-1480.webp"),
        // srcSet: "Versions responsives de cette image",
        alt: "Argent Bank - Swagger endpoint PATCH /transactions/{transactionId} avec identifiant",
      },
    ],
...
//       srcSet: "Versions responsives de cette image (1480w, 1024w, 1480w, etc.)",
